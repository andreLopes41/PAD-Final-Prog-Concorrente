...
async def websocket_handler(websocket, path):
    ...
    try:
        async for message in websocket:
            ...
            # Cria um executor de threads para as buscas
            with concurrent.futures.ThreadPoolExecutor(max_workers=total_termos) as executor:
                futures = [
                    executor.submit(buscar_jogos_plataforma, termo, plataforma)
